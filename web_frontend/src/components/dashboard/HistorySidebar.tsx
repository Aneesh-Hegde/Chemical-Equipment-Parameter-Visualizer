...
export const HistorySidebar = () => {
  const { uploadHistory, setUploadHistory, removeFromHistory, setCurrentData, setStats, setIsLoading } = useDashboard();
  ...
  const handleLoadItem = (item: typeof uploadHistory[0]) => {
    setIsLoading(true);
    try {
